// Загружает палитры из shared design/category_palettes.json и формирует
// объект для ThemeContext движка. Префикс с подчёркиванием (_label, _grain_color)
// фильтруется — это служебные поля для документации.
...
cleaned.default = cleaned.mental_models;
