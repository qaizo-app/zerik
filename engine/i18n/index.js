...
extendStrings({
  ru: {
    ...
    privacy: 'Приватность',
    by_studio_label: 'Студия Qaizo',
    other_studio_apps: 'Другие приложения студии',
    notifications: 'Уведомления',
    daily_reminder: 'Ежедневное напоминание',
    reminder_time: 'Время напоминания',
    reminder_time_picker_title: 'Когда напоминать',
    reminder_time_hour: 'Час',
    reminder_time_minute: 'Мин',
  ...
  en: {
    ...
    privacy: 'Privacy',
    by_studio_label: 'By Qaizo Studio',
    other_studio_apps: 'Other studio apps',
    notifications: 'Notifications',
    daily_reminder: 'Daily reminder',
    reminder_time: 'Reminder time',
    reminder_time_picker_title: 'When to remind',
    reminder_time_hour: 'Hour',
    reminder_time_minute: 'Min',
